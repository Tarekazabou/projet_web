...
/// Curved bottom bar view with center FAB
                  ...
                  child: ScaleTransition(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        boxShadow: <BoxShadow>[
                          BoxShadow(
                            color: MealyTheme.nearlyOrange.withValues(alpha: 0.4),
...
class _TabIconsState extends State<TabIcons> with TickerProviderStateMixin {
  ...
  IconData _getIcon() {
    switch (widget.tabIconData?.index) {
      case 0:
        return widget.tabIconData!.isSelected
            ? Icons.home_rounded
            : Icons.home_outlined;
      case 1:
        return widget.tabIconData!.isSelected
...
/// Custom clipper for curved bottom bar
