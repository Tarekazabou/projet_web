...
@food_scanner_bp.route('/history', methods=['GET'])
def get_scan_history():
    """
    Get history of food scans for the current user.
    ...
    try:
        ...
        for doc in docs:
            ...
            if 'createdAt' in meal and meal['createdAt']:
                meal['createdAt'] = meal['createdAt'].isoformat()
            meals.append(meal)
